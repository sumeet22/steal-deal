    ...
    return (
        <div className="space-y-8 pb-10">
            ...
            <motion.div
                ...
                className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-950 via-slate-900 to-indigo-950 shadow-2xl min-h-[300px] flex items-center justify-center text-center px-4"
            >
                ...
                <div className="relative z-10 max-w-4xl mx-auto space-y-4 p-6">
                    ...
                    >
                        <span className="inline-flex items-center gap-2 py-1 px-3 rounded-full bg-white/10 border border-white/20 text-indigo-200 text-sm font-semibold mb-4 backdrop-blur-sm">
                            <SparklesIcon />
                            Latest Collection
                        </span>
                        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-white via-indigo-100 to-slate-200 mb-2 drop-shadow-sm">
